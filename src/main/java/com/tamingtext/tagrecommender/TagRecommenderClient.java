...
public class TagRecommenderClient {
	...
	public ScoreTag[] getTags(String content, int maxTags)
		...
		ModifiableSolrParams query = new ModifiableSolrParams();// <co
																// id="trc.query"/>
		query.set("fq", "postTypeId:1").set("start", 0).set("rows", 10)
				.set("fl", "*,score").set("mlt.interestingTerms", "details");
		...
		SolrDocumentList documents = response.getResults(); // <co
															// id="trc.results"/>
	...
	/*
	 * <calloutlist> <callout arearefs="trc.server">Solr client</callout>
	 * <callout arearefs="trc.query">Query parameters</callout> <callout
	 * arearefs="trc.request">Create and execute request</callout> <callout
	 * arearefs="trc.results">Collect and rank tags</callout> </calloutlist>
	 */
	...
	protected ScoreTag[] rankTags(SolrDocumentList documents, int maxTags) {
		...
		final ScoreTagQueue pq = new ScoreTagQueue(maxTags); // <co
																// id="trc.rank"/>
	...
	/*
	 * <calloutlist> <callout arearefs="trc.count">Count Tags</callout> <callout
	 * arearefs="trc.rank">Rank Tags</callout> <callout
	 * arearefs="trc.collect">Collect Ranked Tags</callout> <callout
	 * arearefs="trc.score">Score Tags</callout> </calloutlist>
	 */
	...
	/**
	 * Hold a tag returned by the Solr query, it's score and the relative
	 * probability of it appearing in relation to the other results in the set.
	 *
	 */
