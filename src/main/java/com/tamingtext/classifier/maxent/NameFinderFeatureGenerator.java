...
public class NameFinderFeatureGenerator implements FeatureGenerator {
	...
	public Collection extractFeatures(String[] text) {
		NameFinderME[] finders = factory.getNameFinders(); // <co
															// id="nffg.engine"/>
	...
	/*
	 * <calloutlist> <callout arearefs="nffg.engine">Get Name Finders</callout>
	 * <callout arearefs="nffg.find">Find Names</callout> <callout
	 * arearefs="nffg.combine">Extract Names</callout> <callout
	 * arearefs="nffg.return">Collect Names</callout> </calloutlist>
	 */
