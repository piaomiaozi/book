...
public class TrainMaxent {
	...
	public void train(String source, String destination) throws IOException {
		...
		DoccatModel model = DocumentCategorizerME.train("en", ds, cutoff,
				iterations, nffg, bowfg); // <co id="tm.train"/>
		model.serialize(new FileOutputStream(modelFile));

		/*
		 * <calloutlist> <callout arearefs="tm.tok">Create data stream</callout>
	...
	public static void main(String[] args) throws Exception {
		...
		Group group = gbuilder.withName("Options").withOption(helpOpt)
				.withOption(inputDirOpt).withOption(outputOpt).create();
