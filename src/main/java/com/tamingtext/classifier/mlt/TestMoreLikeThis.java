...
public class TestMoreLikeThis {
	...
	private static final Logger log = LoggerFactory
			.getLogger(TestMoreLikeThis.class);
		...
		try {
			...
			for (File ff : inputFiles) { // <co id="co.mlt.read"/>
				...
				while ((line = in.readLine()) != null) {
					...
					ClassifierResult result = hits.length > 0 ? hits[0]
							: UNKNOWN;
					resultAnalyzer.addInstance(parts[0], result); // <co
																	// id="co.mlt.an"/>
				}
			...
			System.out.println(resultAnalyzer.toString());// <co
															// id="co.mlt.print"/>
			/*
			 * <calloutlist> <callout arearefs="co.mlt.ra">Create
			 * <classname>ResultAnalyzer</classname></callout> <callout
			 * arearefs="co.mlt.read">Read Test data</callout> <callout
			 * arearefs="co.mlt.cat">Categorize</callout> <callout
			 * arearefs="co.mlt.an">Collect Results</callout> <callout
			 * arearefs="co.mlt.print">Display Results</callout> </calloutlist>
			 */
