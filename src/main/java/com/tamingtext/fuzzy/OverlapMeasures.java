...
public class OverlapMeasures {
	...
	/*
	 * <calloutlist> <callout arearefs="co_fuzzy_jaccard_dups1"><para>Find
	 * duplicates and subtract from union.</para></callout> <callout
	 * arearefs="co_fuzzy_jaccard_skip1"><para>Skip duplicates.</para></callout>
	 * <callout arearefs="co_fuzzy_jaccard_intersection"><para>Find
	 * intersection.</para></callout> <callout
	 * arearefs="co_fuzzy_jaccard_return"><para>Return Jaccard
	 * distance.</para></callout> </calloutlist>
	 */
	// <end id="jaccard_end"/>

	public TopDocs cosine(String queryTerm, int n, String... terms)
		...
		for (String term : terms) {
			...
			doc.add(new Field("chars", term, Field.Store.YES,
		...
		TopDocs topDocs = searcher
				.search(new MatchAllDocsQuery(), terms.length);
