...
public class SpellCorrector {
	...
	public String topSuggestion(String spelling) throws SolrServerException {
		...
		while (di.hasNext()) {
			...
			float distance = sd.getDistance(word, spelling); // <co
																// id="co.dym.edit"/>
...
/*
 * <calloutlist> <callout arearefs="co.dym.num"><para>The number of n-gram
 * matches to consider.</para></callout> <callout
 * arearefs="co.dym.field"><para>Query the field which contains the
 * n-gram.</para></callout> <callout arearefs="co.dym.edit"><para>Compute the
 * edit distance.</para></callout> <callout arearefs="co.dym.max"><para>Keep
 * best suggestion.</para></callout> <callout
 * arearefs="co.dym.threshold"><para>Check threshold otherwise return no
 * suggestion.</para></callout> </calloutlist>
 */
