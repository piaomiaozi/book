...
public class SentenceDetectorFactory {
	...
	private static final Logger log = LoggerFactory
			.getLogger(SentenceDetectorFactory.class);
	...
	public SentenceDetectorFactory(Map<String, String> param)
			throws IOException {
	...
	public SentenceDetectorFactory(String language, String modelDirectory)
			throws IOException {
		loadSentenceDetector(language, modelDirectory);
	}
	 ...
	 * @throws IOException
	 */
	protected void loadSentenceDetector(String language, String modelDirectory)
			throws IOException {
		String modelFile = modelDirectory + File.separatorChar + language
				+ "-sent.bin";
