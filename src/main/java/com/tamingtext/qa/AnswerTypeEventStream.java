...
public class AnswerTypeEventStream implements EventStream {
	...
	public AnswerTypeEventStream(String fileName, String encoding,
			AnswerTypeContextGenerator atcg, Parser parser) throws IOException {
		if (encoding == null) {
	...
	public AnswerTypeEventStream(String fileName,
			AnswerTypeContextGenerator atcg, Parser parser) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		String modelsDirProp = System.getProperty("models.dir", "book/src/main"
				+ File.separator + "opennlp-models" + File.separator
				+ "english");
		File modelsDir = new File(modelsDirProp);
		File wordnetDir = new File(System.getProperty("wordnet.dir",
				"book/src/main" + File.separator + "WordNet-3.0"
						+ File.separator + "dict"));
