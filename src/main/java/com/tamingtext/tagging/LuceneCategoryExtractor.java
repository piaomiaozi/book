...
public class LuceneCategoryExtractor {
	...
	/**
	 * dump the terms found in the field specified to the specified writer in
	 * the form:
	 * 
	 * <pre>
	 * term(tab)document_frequency
	 * </pre>
	 * 
	 * @param indexDir
	 *            the index to read.
	 ...
	 * @param out
	 *            the print writer output will be written to
	 * @throws IOException
	 */
	public static void dumpTerms(File indexDir, String field, PrintWriter out)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void dumpDocumentFields(File indexDir, String field,
			long maxDocs, PrintWriter out) throws IOException {
		Directory dir = FSDirectory.open(indexDir);
		IndexReader reader = IndexReader.open(dir, true);
