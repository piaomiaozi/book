...
public class QATest extends TTTestCaseJ4 {
	...
	public static void beforeClass() throws Exception {
		...
		initCore("solrconfig-qa.xml", "schema-qa.xml");
	...
	public void testComponent() throws Exception {
		...
		for (int i = 0; i < DOCS.length; i++) {
			...
			assertU("Add a doc to be ranked",
					adoc("id", String.valueOf(i), "details", doc));
		}
		...
		assertQ("Couldn't find query",
				...
				"//result[@numFound=1]", "//str[@name='id'][.='1']");

		assertQ("Couldn't find query",
				req("q", "Who is the greatest basketball player of all time?",
						QAParams.PRIMARY_WINDOW_SIZE, "10"),
				"//result[@numFound=1]", "//str[@name='id'][.='0']",
				"//str[@name='field'][.='details']"

		);

		assertQ("Couldn't find query",
				req("q", "Are cats mammals?", QAParams.PRIMARY_WINDOW_SIZE, "5"),
				"//result[@numFound=1]", "//str[@name='id'][.='3']",
				"//str[@name='field'][.='details']");
