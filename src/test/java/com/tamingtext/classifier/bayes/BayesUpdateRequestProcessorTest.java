...
public class BayesUpdateRequestProcessorTest extends SolrTestCaseJ4 {
	...
	public void testUpdate() {
		...
		assertQ("Couldn't find indexed scifi instance", req("details:Empire"),
				"//result[@numFound=1]", "//str[@name='id'][.='1234']");

		assertQ("Couldn't find indexed fantasy instance",
				req("details:Towers"), "//result[@numFound=1]",
				"//str[@name='id'][.='1235']");

		assertQ("Couldn't find classified scifi instance",
				req("subject:scifi"), "//result[@numFound=1]",
				"//str[@name='id'][.='1234']");

		assertQ("Couldn't find classified fantasy instance",
				req("subject:fantasy"), "//result[@numFound=1]",
				"//str[@name='id'][.='1235']");
	}
}
