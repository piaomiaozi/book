...
public class MoreLikeThisQueryTest {
	...
	public void testMoreLikeThisQuery() throws Exception {
		...
		IndexReader indexReader = IndexReader.open(directory); // <co
																// id="mlt.indexsetup"/>
		...
		MoreLikeThis moreLikeThis = new MoreLikeThis(indexReader); // <co
																	// id="mlt.configure"/>
		moreLikeThis.setAnalyzer(analyzer);
		moreLikeThis.setFieldNames(new String[] { "content" });

		/*
		 * <calloutlist> <callout arearefs="mlt.indexsetup">Open Index</callout>
		 * <callout arearefs="mlt.analyzersetup">Setup Analyzer</callout>
		 * <callout arearefs="mlt.ngramsetup">Setup NGrams</callout> <callout
		 * arearefs="mlt.configure">Create
		 * <classname>MoreLikeThis</classname></callout> </calloutlist>
		 */
		...
		TopDocs results = indexSearcher.search(query, maxResults); // <co
																	// id="mlt.search"/>
		...
		/*
		 * <calloutlist> <callout arearefs="mlt.query">Create Query</callout>
		 * <callout arearefs="mlt.search">Perform Search</callout> <callout
		 * arearefs="mlt.collect">Collect Results</callout> <callout
		 * arearefs="mlt.rank">Rank Categories</callout> <callout
		 * arearefs="mlt.display">Display Categories</callout> </calloutlist>
		 */
